...
from common_utils.render import renderImageToFile,render
...
def main():# Define Canvas Boundaries
    ...
    shaded_canvas =  render(verts2d,faces,vcolors,depth,'gouraud')
    ...
    renderImageToFile(shaded_canvas,save=True,filename='Gouraud_shading_Res')
